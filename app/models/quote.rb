class Quote < ActiveRecord::Base
  ...
  @sort_columns = { # this will get populated using the sortable class method once the library is created
    :price        => {:column_name => :price,     :default => 'ASC',  :joins => nil,      :clause => 'quotes.price'},
    :quantity     => {:column_name => :quantity,  :default => 'DESC', :joins => nil,      :clause => 'quotes.quantity'},
